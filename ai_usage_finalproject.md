...
- Snippet of prompt(s): "Write a function that dies the following for all species (scientific_name) for the attached dataset..."; "Yes, can you please also combine all BCR trends into one master table, and classify trends"; "Yes, please also provide CIs and use them in the statistical thresholds"; "can you also add the CIs to the tables and csv files"; "can you modify this code to filter the scientific name field and filters out any that have " / ", " sp." or " x " prior to implementing the rest of the function"; "can you modify this code to filter the scientific name field and filters out any that have " / ", " sp." or " x " prior to implementing the rest of the function"
